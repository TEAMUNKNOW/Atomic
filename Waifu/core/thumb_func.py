...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    black = Image.open("Waifu/core/resources/black.jpg")
    img = Image.open("Waifu/core/resources/music.png")
    ...
    font1 = ImageFont.truetype(r'Waifu/core/resources/robot.otf', 30)
    font2 = ImageFont.truetype(r'Waifu/core/resources/robot.otf', 60)
    font3 = ImageFont.truetype(r'Waifu/core/resources/robot.otf', 49)
    font4 = ImageFont.truetype(r'Waifu/core/resources/Waifu.ttf', 35)

    image4 = ImageDraw.Draw(image2)
    image4.text((10, 10), "Waifu MUSIC", fill="white", font = font1, align ="left") 
