...
@Waifu.on_message(filters.command("bass") & filters.reply)
async def download_and_enhance_audio(client, message):
    try:
        ...
        if reply_message.audio:
            ...
            enhanced_audio.export("Waifu.mp3", format="mp3")
            await msg.delete()
            await message.reply_audio("Waifu.mp3")
        else:
...
@Waifu.on_message(filters.command("loudly") & filters.reply)
async def download_and_enhance_audio(client, message):
    try:
        reply_message = message.reply_to_message
        ...
        if reply_message.audio:
            ...
            louder_audio.export("Waifu.mp3", format="mp3")
            await msg.delete()
            await message.reply_audio("Waifu.mp3")
        else:
            await message.reply("The replied message is not an audio.")
...
@Waifu.on_message(filters.command("mono") & filters.reply)
async def split_stereo_and_send_audio(client, message):
    try:
        ...
        if reply_message.audio:
            ...
            mono_audio.export("Waifu.mp3", format="mp3")
            await msg.delete()
            await message.reply_audio("Waifu.mp3")
        else:
            await message.reply("The replied message is not an audio.")
