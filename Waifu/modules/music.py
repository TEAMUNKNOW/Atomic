...
import requests
from Waifu.core.admin_func import authorized_users, admins as a, set_admins as set
from Waifu import Waifu, pytgcalls, userbot
...
from Waifu.core import utils as rq
from Waifu.core.utils import DurationLimitError
from Waifu.core.utils import get_audio_stream, get_video_stream
from pytgcalls.types import Update
from pytgcalls.types import AudioPiped, AudioVideoPiped, AudioQuality, AudioParameters
from Waifu.core.thumb_func import transcode, convert_seconds, time_to_seconds, generate_cover
...
@Waifu.on_message(filters.command(["play"], prefixes=["/","."]))
...
@Waifu.on_message(filters.command(["vplay"], prefixes=["/","."]))
...
@Waifu.on_message(filters.command(["skip", "next"], prefixes=["/", "!"]))
...
@Waifu.on_message(filters.command("join"))
@authorized_users
...
@Waifu.on_message(filters.command(["pause"], prefixes=["/", "!"]))    
@authorized_users
...
@Waifu.on_message(filters.command(["resume"], prefixes=["/", "!"])) 
@authorized_users
...
@Waifu.on_message(filters.command(["end"], prefixes=["/", "!"])) 
@authorized_users
...
@Waifu.on_message(filters.command(["leavevc"], prefixes=["/", "!"]))
@authorized_users
...
@Waifu.on_message(filters.command("volume", prefixes="/"))
